...
/// <summary>
/// Base class for 3D graphs, can be built upon.
/// </summary>
/// <typeparam name="TNode">Type of node to be used in the graph.</typeparam>
public class Graph3D : Graph<Node3D>, IGraph<Node3D>, IGraph3D
{
    /// <summary>
    ...
    public Graph3D(IReadOnlyGraph<Node3D> graph) : base(graph)
    {
    }
    ...
    /// </summary>
    public Graph3D(Dictionary<uint, Node3D> nodes, Dictionary<uint, Edge> edges) : base(nodes, edges)
    {
    }
