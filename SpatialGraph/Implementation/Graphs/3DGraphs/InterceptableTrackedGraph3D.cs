...
public class InterceptableTrackedGraph3D : InterceptableTrackedGraph<Node3D>, IGraph<Node3D>, IGraph3D
{
    /// <summary>
    /// Start an empty graph.
    /// </summary>
    public InterceptableTrackedGraph3D() : base()
    {
    }
    ...
    public InterceptableTrackedGraph3D(IReadOnlyGraph<Node3D> graph) : base(graph)
    {
    }
    ...
    /// </summary>
    public InterceptableTrackedGraph3D(Dictionary<uint, Node3D> nodes, Dictionary<uint, Edge> edges) : base(nodes, edges)
    {
    }
